...
const Trailer = ({ videos }) => {
  // const [modalVideoOpened, setModalVideoOpened] = useState(true);
  ...
  return (
    <>
      {/* <Button
        ...
        <div className='modal-video modal-video-body modal-video-movie-wrap'>
        <iframe className='modal-video-inner iframe' src={`https://www.youtube.com/embed/${videoId}`} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
          {/* <ModalVideo
          isOpen={true}
          channel='youtube'
