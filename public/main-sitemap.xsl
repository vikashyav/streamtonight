			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - day2movies Route</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - day2movies Route</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://streamtonight.online/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
